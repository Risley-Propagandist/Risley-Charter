...
\centerline{\textsc{Current as of 23 February 2017}}
\hrulefill
...
\item \textbf{Switzerland Clause.} During voting, when the House is Divided, the RHD, the RAs, the AIR, the GV, and the Chair have the option to abstain from voting. (Spring 2010, moved Spring 2015, revised Fall 2015)
...
\begin{enumerate}[1.]
\item \textbf{Quiet Hours.} (Deleted Fall 2015)
\begin{enumerate}[A.]
\item General
\begin{enumerate}[a.]
...
\end{enumerate}
\end{enumerate}
\item \textbf{The Rocky Horror Picture Show.} (rev. Fall 2006, rev. Spring 2010, rev. Spring 2015)
\begin{enumerate}[A.]
...
\item Voting shall be available at the voting booth Wednesday through Friday of the third full week of classes; (rev. Spring 2015)
\item Physical ballots, if used, shall be available at the voting booth. Otherwise, computers or tablets shall be made available at the booth for the purpose of voting; (rev. Spring 2015)
\item The voting booth shall be staffed by volunteers, who, if possible, should not be candidates for office;
\item In the event that physical ballots are used, cast ballots shall be placed in a seal container, and names shall be recorded-- separate from ballots--to ensure no person votes more than once; (rev. Spring 2015)
...
(moved Fall 2007)
\item The election facilitator may request permission to use an electronic voting system. (Spring 2015)
\begin{enumerate}[a.]
    \item Before an electronic voting system may be used for an election, that specific system must be approved for that election by a 2/3rds majority vote of Kommittee. (Spring 2015)
    \end{enumerate}
\end{enumerate}
...
\item In a multiple-choice referendum, an Instant Runoff (Single-Transferable Vote) system shall be used.
...
\item \textbf{Representatives to the Residential Student Congress.} A number of representatives, as determined by the Residential Student Congress (RSC), shall be elected by Kommittee each semester to represent Risley at the Residential Student Congress. They will be tasked with reporting to Kommittee on the business of the RSC. (Fall 2015)
\end{enumerate}
\section*{Subcommittees}
\begin{enumerate}[1.]
